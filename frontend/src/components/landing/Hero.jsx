...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-ink-950">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-start justify-center px-5 pb-28 pt-32 sm:px-8">
        <p className="animate-fade-up text-eyebrow font-semibold uppercase text-gold-400">
          AI Career Readiness
        </p>
        <h1
          className="mt-6 max-w-3xl animate-fade-up font-display text-display-xl font-medium text-paper-50"
